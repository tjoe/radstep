...
{
   if($rsauth->EmailResetPasswordLink())
   {
        $rsauth->RedirectToURL("resetpwdsent.html");
        exit;
   }
}
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	<div id="div_main" style="margin:0 auto;">
		...
		<div class='container'>
		    ...
		    <input type='text' name='email' id='email' value='<?php echo $rsauth->SafeDisplay('email') ?>' maxlength="50" /><br/>
